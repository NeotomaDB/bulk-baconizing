...
There are several ways of working with this repository.  If you are not familiar with Github and simply wish to run the code locally, then navigate to the GitHub repository for this project, and click the green **Clone or download** button.  From there, select **Download ZIP**. 

![](images/download_file.png)

If you are familiar with GitHub and wish to use `git` as part of your workflow then you can also choose to clone the repository.  To do this, you can either [fork the repository](), which would make a copy of it under your own personal GitHub account, or you can clone it directly and [make a new branch]().
